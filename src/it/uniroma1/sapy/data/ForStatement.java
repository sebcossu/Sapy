 ...
 * @author seb
 */
public class ForStatement extends Statement implements Eseguibile
{
    private ArrayList<Token> vars = new ArrayList<Token>();
    private Boolean hasVars = true;
    
    public ForStatement(Token lab, Token val, Token toval)
    {
        super(TokenType.FOR);
        vars.add(lab);
        vars.add(val);
    ...
    public ForStatement(ForStatement fs)
    {
        super(TokenType.FOR);
