 ...
 */
public class WhileStatement extends Statement implements Eseguibile
{
	 ...
	 */
    public WhileStatement(Istruzione e)
    {
     ...
     */
    public WhileStatement(WhileStatement ws)
    {
        super(TokenType.WHILE);
        espressione = new Istruzione(ws.getExpression());
        hasVars = false;
    }
     ...
     */
    public WhileStatement(ArrayList<Token> art)
    {
        super(TokenType.WHILE);
        espressione = null;
    ...
    {
    	if(espressione != null)
    		return "WHILE + " + espressione.esegui().toString() + " -- made by " + espressione.getRoot().toString();
    	else return "WHILE " + this.right.esegui().toString();
    }
